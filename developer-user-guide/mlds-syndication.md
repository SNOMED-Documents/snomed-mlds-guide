...
Based on existing work implemented by the [Australian Digital Health Agency](https://www.google.com/url?q=https://www.healthterminologies.gov.au/specs/v2/conformant-server-apps/syndication-api/syndication-feed/&sa=D&source=editors&ust=1775051389954061&usg=AOvVaw1pClY99K80hvPnlvBjheVl), this feed extends the [Atom Syndication Standard](https://www.google.com/url?q=https://tools.ietf.org/html/rfc4287&sa=D&source=editors&ust=1775051389954287&usg=AOvVaw2aTzhFRebC7s6Nv20Mr4TJ). It is not specific to SNOMED CT and can be used for any relevant healthcare standard,
...
A live feed is now available from SNOMED International - [Members Distribution and Licensing Service](https://www.google.com/url?q=https://mlds.ihtsdotools.org/api/feed&sa=D&source=editors&ust=1775051389955335&usg=AOvVaw3UH3UljL88lZpmNVS04buE)

Example feed can be seen in this repo - [feed-example.xml](https://www.google.com/url?q=https://github.com/IHTSDO/termserver-syndication/blob/main/feed-example.xml&sa=D&source=editors&ust=1775051389955674&usg=AOvVaw1qZ-ql4MbEjCXXWl063PrS).
...
[Edition packages](https://www.google.com/url?q=https://confluence.ihtsdotools.org/display/DOCGLOSS/edition&sa=D&source=editors&ust=1775051389956607&usg=AOvVaw1Ppkjusi3fLsc_f9OWBkOK) by definition include all their dependencies and therefore do not have a sct:packageDependency element.

[Extension packages](https://www.google.com/url?q=https://confluence.ihtsdotools.org/display/DOCGLOSS/extension&sa=D&source=editors&ust=1775051389956910&usg=AOvVaw0oeTGqFPwwLVOs3BjUjj9B) always depend on other packages' content not included in the extension package and therefore always have a sct:packageDependency element.

[Edition packages](https://www.google.com/url?q=https://confluence.ihtsdotools.org/display/DOCGLOSS/edition&sa=D&source=editors&ust=1775051389957440&usg=AOvVaw3EgtMDdTNbEldTLyepI8-Y) and [Extension packages](https://www.google.com/url?q=https://confluence.ihtsdotools.org/display/DOCGLOSS/extension&sa=D&source=editors&ust=1775051389957568&usg=AOvVaw35r7cI2xVeU__agFNS-Gba) can therefore be distinguished by the absence or presence of a sct:packageDependency element.
...
2.  The [RF2 Release Type](https://www.google.com/url?q=https://confluence.ihtsdotools.org/display/DOCRELFMT/3.2%2BRelease%2BTypes&sa=D&source=editors&ust=1775051389968199&usg=AOvVaw1iMME_2uMOHdZasedonlDG) Full/Snapshot should be included as a bracketed suffix to the title

...
Working with the SNOMED CT community, SNOMED International produced the following syndication standard, which has now been implemented in MLDS. The feed can be viewed here: [https://mlds.ihtsdotools.org/api/feed](https://www.google.com/url?q=https://mlds.ihtsdotools.org/api/feed&sa=D&source=editors&ust=1775047855801842&usg=AOvVaw1BuUW46MsmqpyRNyTf6Muk)
...
Based on existing work implemented by the [Australian Digital Health Agency](https://www.google.com/url?q=https://www.healthterminologies.gov.au/specs/v2/conformant-server-apps/syndication-api/syndication-feed/&sa=D&source=editors&ust=1775047855802756&usg=AOvVaw19d0H3-2llVFs0w1MAUro8), this feed extends the [Atom Syndication Standard](https://www.google.com/url?q=https://tools.ietf.org/html/rfc4287&sa=D&source=editors&ust=1775047855802927&usg=AOvVaw0lXTRGxR-HKg89ovv4Zsfw). It is not specific to SNOMED CT and can be used for any relevant healthcare standard,

The additions here are from SNOMED International and are in the sct namespace, http://snomed.info/syndication/sct-extension/1.0.0, for distributing SNOMED CT content, including editions, extensions and derivatives.

### SNOMED CT Specific extensions

A live feed is now available from SNOMED International - [Members Distribution and Licensing Service](https://www.google.com/url?q=https://mlds.ihtsdotools.org/api/feed&sa=D&source=editors&ust=1775047855803860&usg=AOvVaw1ydwbn-B_5Q3BFxYik8Aa7)

Example feed can be seen in this repo - [feed-example.xml](https://www.google.com/url?q=https://github.com/IHTSDO/termserver-syndication/blob/main/feed-example.xml&sa=D&source=editors&ust=1775047855804169&usg=AOvVaw13n7pcff69AoxlWYIVRxWU).
...
[Edition packages](https://www.google.com/url?q=https://confluence.ihtsdotools.org/display/DOCGLOSS/edition&sa=D&source=editors&ust=1775047855804990&usg=AOvVaw3ZmFheX-vj82P_hwqMylPs) by definition include all their dependencies and therefore do not have a sct:packageDependency element.

[Extension packages](https://www.google.com/url?q=https://confluence.ihtsdotools.org/display/DOCGLOSS/extension&sa=D&source=editors&ust=1775047855805363&usg=AOvVaw31wbZ5sSjYNkJJENq19UHY) always depend on other packages' content not included in the extension package and therefore always have a sct:packageDependency element.

[Edition packages](https://www.google.com/url?q=https://confluence.ihtsdotools.org/display/DOCGLOSS/edition&sa=D&source=editors&ust=1775047855805813&usg=AOvVaw3fLHNxNmEw4J8g0Glwf7UX) and [Extension packages](https://www.google.com/url?q=https://confluence.ihtsdotools.org/display/DOCGLOSS/extension&sa=D&source=editors&ust=1775047855805967&usg=AOvVaw3eoVE-6tkhGm8WXRMPSCr6) can therefore be distinguished by the absence or presence of a sct:packageDependency element.
...
For editions, most implementers want a ready to use package rather than parts and assembly instructions. Assembling an edition from an extension package and a base edition is not a trivial exercise, requiring content to be combined and a snapshot calculated based on the [Module Dependency Reference Set](https://www.google.com/url?q=https://confluence.ihtsdotools.org/display/DOCRELFMT/5.2.4.2%2BModule%2BDependency%2BReference%2BSet&sa=D&source=editors&ust=1775047855810482&usg=AOvVaw3LCMokycDOacg8j3MqPgpt).
...
-   the majority of implementers would prefer a ready to use edition package, and the task of assembling that from an extension and base edition package and calculating a snapshot based on the [Module Dependency Reference Set](https://www.google.com/url?q=https://confluence.ihtsdotools.org/display/DOCRELFMT/5.2.4.2%2BModule%2BDependency%2BReference%2BSet&sa=D&source=editors&ust=1775047855811791&usg=AOvVaw193ATGCGsrr7AcC49MvInD) is burdensome.
...
An Extension (adding/modifying core components) published as an extension package should only be a Delta or a Full [RF2 Release Type](https://www.google.com/url?q=https://confluence.ihtsdotools.org/display/DOCRELFMT/3.2%2BRelease%2BTypes&sa=D&source=editors&ust=1775047855813761&usg=AOvVaw0StyIRF5KQHReYrcf2fU9s). Such a package can be applied to a referenced base edition, and then a Snapshot calculated using the [Module Dependency Reference Set](https://www.google.com/url?q=https://confluence.ihtsdotools.org/display/DOCRELFMT/5.2.4.2%2BModule%2BDependency%2BReference%2BSet&sa=D&source=editors&ust=1775047855814078&usg=AOvVaw1C__gGWdVQJoSYT94k8oFa). Because an Extension affects the Snapshot state in this way, potentially requiring reclassification and Necessary Normal Form recalculation, a Snapshot extension package of an Extension cannot be simply appended to a base edition's Snapshot. For this reason, the Snapshot Release Type for extension packages of SNOMED CT Extensions should not be used.
...
1.  The version of the package should be included in the title
2.  The [RF2 Release Type](https://www.google.com/url?q=https://confluence.ihtsdotools.org/display/DOCRELFMT/3.2%2BRelease%2BTypes&sa=D&source=editors&ust=1775047855816425&usg=AOvVaw3xNk9RTdJCoLpswRW4jPxZ) Full/Snapshot should be included as a bracketed suffix to the title

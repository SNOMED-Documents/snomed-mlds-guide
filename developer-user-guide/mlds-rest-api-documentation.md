...
For further information on the REST APIs to get access to releases, please go to the [MLDS Release Packages API](http://../MLDS-Release-Packages-API_18776142.html) page.
### Schema
